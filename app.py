...
def get_chord():
    ...
    display_answer = correct_answer.replace("sharp", "#").replace("_", "")
...
def serve_sound(filename):
    filename = filename.replace("#", "sharp")  # アンダースコアは残す
...
def check_answer():
    ...
    display_answer = data.get('correct_answer', data.get('correct_raw', '')).replace("sharp", "#").replace("_", "")
